...
import anomaly_detection_pb2 as anomaly__detection__pb2


class TwitterAnomalyDetectionStub(object):
...
class TwitterAnomalyDetectionServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_TwitterAnomalyDetectionServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'twitteranomalydetection.TwitterAnomalyDetection', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class TwitterAnomalyDetection(object):
    """Missing associated documentation comment in .proto file."""
